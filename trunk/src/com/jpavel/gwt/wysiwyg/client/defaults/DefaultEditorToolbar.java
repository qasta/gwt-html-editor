...
import com.jpavel.gwt.wysiwyg.client.EditorColorPicker;
import com.jpavel.gwt.wysiwyg.client.EditorColorSelectListener;
import com.jpavel.gwt.wysiwyg.client.EditorToolbar;
import com.jpavel.gwt.wysiwyg.client.EditorToolbarButton;
import com.jpavel.gwt.wysiwyg.client.EditorToolbarSelect;
  ...
  public DefaultEditorToolbar(Editor edt) {
    ...
    link.addClickListener(new ClickListener() {
      public void onClick(Widget sender) {
        new SimpleOneFieldPromptPanel(DefaultEditorToolbar.this.editor, "CreateLink", "Create Link", "Link URL: ", "Create Link");
      }
    });
    ...
    image.addClickListener(new ClickListener() {
      public void onClick(Widget sender) {
        new SimpleOneFieldPromptPanel(DefaultEditorToolbar.this.editor, "InsertImage", "Insert Image", "Image URL: ", "Insert Image");
      }
    });
